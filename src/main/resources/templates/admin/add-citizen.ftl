        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form class="search-form" target="_self" action="/admin/search-citizen">
            ...
            <#if searchedCitizens?? >
                <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                    <#list searchedCitizens as citizen>
                        <tr>
                            <td>${citizen.getId()}</td>
                            <td>
                                <a id="med-rec-link" href="/admin/edit-citizen/${citizen.getId()}">${citizen.getName()}</a>
                            </td>
