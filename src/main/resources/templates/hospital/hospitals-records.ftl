            ...
            <div class="col-md-12">
                ...
                <form class="search-form" target="_self" action="/hospital/hospitals-records">
                    <div class="input-group">
                        ...
                        <input class="form-control" type="text" name="search" placeholder="Search for Patient  . . .">
                    ...
                    <#if medicalRecords?? >
                        <#list medicalRecords as medicalrecord>
                            <tr>
                                ...
                                <td>
                                    <a id="med-rec-link"
                                       href="/hospital/edit-medical-record/${medicalrecord.getId()}/${medicalrecord.getCitizen().getId()}">${medicalrecord.getTitle()}</a>
                                </td>
                                <td>${medicalrecord.getDoctor()}</td>
                                <td><a id="med-rec-link"
                                       href="/${medicalrecord.citizen.getId()}">${medicalrecord.citizen.getName()}</a>
                                </td>
                            </tr>
