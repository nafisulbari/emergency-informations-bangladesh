                ...
                <form class="search-form" target="_self" action="/police/police-stations-records">
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-search"
                                                                                           style="color:rgb(23,162,185);font-size:22px;"></i></span>
                        </div>
                        <input class="form-control" type="text" name="search" placeholder="Search by Criminal  . . .">
                    ...
                    <#if criminalRecords?? >
                        <#list criminalRecords as criminalRecord>
                            <tr>
                                ...
                                <td>
                                    <a id="med-rec-link"
                                       href="/police/edit-criminal-record/${criminalRecord.getId()}/${criminalRecord.getCitizen().getId()}">${criminalRecord.getTitle()}</a>
                                </td>
                                <td>${criminalRecord.getLocation()}</td>
                                <td><a id="med-rec-link"
                                       href="/${criminalRecord.citizen.getId()}">${criminalRecord.citizen.getName()}</a>
                                </td>
                            </tr>
